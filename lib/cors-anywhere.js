...
function proxyRequest(req, res, proxy) {
  ...
  // cert = res.headers['x-cert'] == undefined ? null : Buffer.from(res.headers['x-cert'], 'base64').toString();
  // key = res.headers['x-key'] == undefined ? null : Buffer.from(res.headers['x-key'], 'base64').toString();  
